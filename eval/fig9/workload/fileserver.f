...
define process name=filereader,instances=1
{
  ...
  {
    flowop createfile name=createfile1,filesetname=bigfileset,fd=1,directio
    flowop writewholefile name=wrtfile1,srcfd=1,fd=1,iosize=$iosize,directio
    flowop closefile name=closefile1,fd=1
    flowop openfile name=openfile1,filesetname=bigfileset,fd=1,directio
    flowop appendfilerand name=appendfilerand1,iosize=$meanappendsize,fd=1,directio
